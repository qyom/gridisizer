...
class Qyom_Response
{
    ...
    /*
     * access protected member error twodimensional array
     * and makes it one dimensional as current response object requires 
     * 
     * @param array $halo_response_array
